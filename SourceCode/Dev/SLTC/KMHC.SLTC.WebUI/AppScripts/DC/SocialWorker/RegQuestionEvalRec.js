...
.controller('RegQuestionEvalRecCtrl', ['$rootScope', '$scope', 'utility', '$state', 'dictionary', 'cloudAdminUi', 'dc_PersonBasicRes', 'dc_RegQuestionEvalRecRes',
    function ($rootScope, $scope, utility, $state, dictionary, cloudAdminUi, dc_PersonBasicRes, dc_RegQuestionEvalRecRes) {
        ...
        $scope.PrintPreview = function (id) {
            if (angular.isDefined(id) && id != null) {
                window.open('/DC_Report/Preview?templateName=DCS1.6&recId=' + id);
            } else {
        ...
        $scope.DownloadWord = function (id) {
            if (angular.isDefined(id) && id != null) {
                window.open('/DC_Report/DownLoadSocialReport?templateName=DCS1.6&recId=' + id);
            } else {
