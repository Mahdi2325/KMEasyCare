...
{
    public class BillV2ForThisSelfAndLastPreAmt
    {
        /// <summary>
        /// 账单ID
        /// </summary>
    ...
    public class BillV2ForThisSelfAndLastPreAmtList
    {
        public BillV2ForThisSelfAndLastPreAmtList()
        {
            BillV2Lists = new List<BillV2ForThisSelfAndLastPreAmt>();
        }
        public List<BillV2ForThisSelfAndLastPreAmt> BillV2Lists { get; set; }
    }
}
