...
.controller("demo1Ctrl", ['$scope', '$state', 'commWordRes', 'utility', function ($scope, $state, commWordRes, utility) {
    ...
    $scope.Data = { Test: "001,002,008", Language: '台语,国语', Plan: '123' };
    $scope.IsInvalid = false;
    $scope.jsonData = [{ "ItemCode": "002", "ItemType": "DC01.002", "ItemName": "手输语" },{ "ItemCode": "002", "ItemType": "DC01.002", "ItemName": "国语" }, { "ItemCode": "002", "ItemType": "DC01.002", "ItemName": "台语" }, { "ItemCode": "002", "ItemType": "DC01.002", "ItemName": "？周後，伤口能缩小至      ×     cm" }, { "ItemCode": "002", "ItemType": "DC01.002", "ItemName": "沟通对饮食的喜好(或许需要使用沟通书写板)" }, { "ItemCode": "002", "ItemType": "DC01.002", "ItemName": "言语沟通的能力改善，每天由口摄取2-3公升液体和75﹪的食物" }];
    $scope.TestId = "ASS";
    var jsonData = [];
