...
(function(root, factory) {
    ...
    BootstrapDialog.METHODS_TO_OVERRIDE['v3.1'] = {
        ...
        updateZIndex: function() {
            ...
            // 修复了添加了backdrop配置项导致的$backdrop为空的问题。 By Chad Chen @ 20150806
            if ($backdrop) { 
    ...
    BootstrapDialog.prototype = {
        ...
        /* 
         * backdrop作为可以配置项，默认：'static'，用于遮罩层不用背景色的情况。By Chad Chen @ 20150806
         */
        getBackdrop: function() {
            return this.options.backdrop;
        },
        ...
        realize: function() {
            ...
            this.getModal().data('bs.modal', new BootstrapDialogModal(this.getModal(), {
                /* 原代码：backdrop: 'static', 
                 * 修改为可以配置项，默认：'static'，用于遮罩层不用背景色的情况。By Chad Chen @ 20150806
                 */ 
                backdrop: this.getBackdrop() === undefined ? 'static' : this.getBackdrop(),
                keyboard: false,
                show: false
            }));
